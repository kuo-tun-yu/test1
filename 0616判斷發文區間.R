...
#--------------XGBoost----------------------
z1 = which(b3$heart<100)
b3[z1,'heart']=1
z2 = which(b3$heart>=100 | b3$heart<500)
b3[z2,'heart']=2
z3 = which(b3$heart>=500 | b3$heart<1000)
b3[z3,'heart']=3
z4 = which(b3$heart>=1000)
b3[z4,'heart']=4
b3$heart = as.factor(b3$heart) 
...
theF<-function(A){
  p1 = which(A<100)
  A[p1]=1
  p2 = which(A>=100 | A<500)
  A[p2]=2
  p3 = which(A>=500 | A<1000)
  A[p3]=3
  p4 = which(xgb.Prediction>=1000)
  A[p4]=4
  return(A)
}
#進行轉換
